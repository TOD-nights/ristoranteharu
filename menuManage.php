				...
				<div class="card mb-3">
					...
					<div class="card-body">
                            ...
                            <div class="form-group">
								...
								<input type="number" class="form-control" name="price"  step="0.01"  required min="1">
							</div>	
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="file" name="image" id="image" accept=".jpg" class="form-control"  style="border:none;">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/img/food-'.$foodId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/img/food-<?php echo $foodId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
			...
			<div class="text-left my-2 row">
				<div class="form-group col-md-6">
                	...
                	<input class="form-control" id="price" name="price" value="<?php echo $foodPrice; ?>" type="number" step="0.01" min="1" required>
				</div>
				<div class="form-group col-md-6">
            ...
            <div class="text-left my-2">
                ...
                <textarea class="form-control" id="desc" name="desc" rows="2" ><?php echo $foodDesc; ?></textarea>
            </div>
            <input type="hidden" id="foodId" name="foodId" value="<?php echo $foodId; ?>">
