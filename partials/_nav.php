...
<div class="text-center image-size-big position-relative mx-2">
      <a href="index.php"><img src="img/logoO.jpg"  style="width:50px; height:50px"></a>
    </div>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        echo '<a href="viewCart.php"><button type="button" class="btn btn-success mx-2" title="MyCart">
