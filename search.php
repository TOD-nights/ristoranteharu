                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="viewfoodList.php?catid=' . $catId . '" class="btn" style="background-color: #568716; color: #fff;">View All</a>
                        </div>
                    </div>
                </div>';
            }
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <h6 style="color: #ff0000"> '.$foodPrice. '€</h6>
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn mx-2" style="background-color: #568716; color: #fff;">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="btn mx-2" style="background-color: #568716; color: #fff; ">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn" style="background-color: #568716; color: #fff; mx-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewfood.php?foodid=' . $foodId . '"><button class="btn" style="background-color: #568716; color: #fff;">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
