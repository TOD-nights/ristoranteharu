    ...
    <div class="container" id="cont">
        <div class="row">
            <div class="alert alert-info mb-0" style="width: -webkit-fill-available;">
              <strong>Info!</strong> Pagamento online non è disponibile.
            </div>
                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    if($totalPrice>20)
                                        $prezzosconto=$totalPrice*0.9;
                                    else
                                        $prezzosconto=$totalPrice;

                                        
                                    $spedizione=$prezzosconto +2;
            ...
            <div class="col-lg-4">
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0 bg-light">prezzo originale<span><?php echo $totalPrice ?>€</span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3 bg-light">
                            <div>
                                    prezzo dopo sconto
                                    <p class="mb-0">(sconto si applica per ordine maggiore di 20€)</p>
                                </div>
                                <span><?php echo $prezzosconto ?>€</span>
                            </li>

                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">costo spedizione<span>2€</span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3 bg-light">
                            <div>
                            <strong>prezzo totale dopo sconto </strong>
                                    <strong><p class="mb-0">(incluso spedizione)</p></strong>
                                </div>
                                <span><strong><?php echo $spedizione ?>€</strong></span>
                        ...
                        <button id="myButton" type="button" class="btn" style="background-color: #568716; color: #fff; btn-block"
                         data-toggle="modal" data-target="#checkoutModal">COMPILA INDIRIZZO</button>
                    </div>
                </div>


                    <!-- PAGAMENTO ONLINE STIPRE -->
                <div class="col-md-10">
                    <div class="card">
                        
                        <div class="card-body text-center">
                            
                        <h5 class="price"><span class="currency">paga <?php echo $spedizione ?>€ online</span></h5>
                            <br>
                ...
                <input type="hidden" name="amount" value="<?php echo $spedizione; ?>">
                              <script
                                ...
                                data-key="pk_test_51O9cicDTdTaOGMokgrXBJsSnZ1VkHbfBE9cqzIEC0Ya5CNJlV9THe5hDhG3bHEH5yFUnZloZPQwzymHZDtsoUtq400VqJjs3SU"
                                data-currency="EUR"
                                data-amount="<?php echo $spedizione * 100; ?>"
                                data-name="RISTORANTE HARU"
