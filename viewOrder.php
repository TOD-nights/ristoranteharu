        ...
        <div class="table-wrapper" id="empty">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-8">						
                        <a href="" class="btn" style="background-color: #568716; color: #fff;"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
            ...
            <table class="table table-striped table-hover text-center">
                ...
                <tbody>
                    <?php
                        ...
                        if($paymentMode == 3) {
                            $tpaymentMode = "bancomat";
                        }

                        if($paymentMode == 2) {
                            $tpaymentMode = "contante";
                        }
