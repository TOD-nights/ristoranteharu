    ...
    <div class="container my-4" id="cont">
        ...
        echo  '<div class="col-md-4">
            ...
            <div class="col-md-8 my-4">
                <h3>' . $foodName . '</h3>
                <h5 style="color: #ff0000"> '.$foodPrice. '€</h5>
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="partials/_manageCart.php" method="POST">
                              ...
                              <button type="submit" name="addToCart" class="btn" style="background-color: #568716; color: #fff; my-2">Add to Cart</button>';
                    }else {
                        echo '<a href="viewCart.php"><button class="btn" style="background-color: #568716; color: #fff; my-2">Go to Cart</button></a>';
                    }
                }
                else{
                    echo '<button class="btn" style="background-color: #568716; color: #fff; my-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                }
                echo '</form>
