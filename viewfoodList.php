                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn" style="background-color: #568716; color: #fff;"">Add to Cart</button>';
                                    }else {
                                        echo '
           
                                        <a href="viewCart.php"><button class="btn" style="background-color: #568716; color: #fff;">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn" style="background-color: #568716; color: #fff;" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                            echo '</form>                            
                                <a href="viewfood.php?foodid=' . $foodId . '" class="mx-2"><button class="btn" style="background-color: #568716; color: #fff;">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
